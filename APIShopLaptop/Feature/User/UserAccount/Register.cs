...
namespace APIShopLaptop.Feature.User.UserAccount {
    public class Register : IEndpoint {
        public record Request(string UserName, string Password, string ConfirmPassword, string Email);
        ...
        public sealed class Validator : AbstractValidator<Request> {
            public Validator() {
                ...
                RuleFor(r => r.Password).MinimumLength(3).WithMessage("Mật khẩu phải nhập tối thiểu 3 ký tự!");
        ...
        private static async Task<IResult> Handler(Request request, ApplicationDBContext context, UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, ClaimsPrincipal User, EmailSender emailSender) {
            try {
