...
using APIShopLaptop.Middleware;
    ...
    public class SendChangePasswordRequest : IEndpoint {
        ...
        public sealed class Validator : AbstractValidator<Request> {
            public Validator() {
                ...
                RuleFor(r => r.OldPassword).MinimumLength(3).WithMessage("Mật khẩu phải nhập tối thiểu 3 ký tự");
                RuleFor(r => r.NewPassword).NotEmpty().WithMessage("Chưa nhập mật khẩu");
                RuleFor(r => r.NewPassword).MinimumLength(3).WithMessage("Mật khẩu phải nhập tối thiểu 3 ký tự");
