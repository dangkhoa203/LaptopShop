...
export default function BuildItemCard(props:{products: buildProduct[],componentName:string,reFetch:()=>void,updateAble:boolean,categoryId:string,required:boolean}) {
    ...
    return(
        <>
            {product ?
                ...
                :
                <BuildItemChooseCard componentName={props.componentName} categoryId={props.categoryId}  product={product} reFetchBuild={props.reFetch} required={props.required}/>
            }
        </>
    )
}